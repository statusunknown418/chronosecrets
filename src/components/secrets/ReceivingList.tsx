...
const ReceivingSecretCard = ({
  ...
  return (
    <article className="flex flex-col gap-4 rounded-lg border bg-muted/70 text-center text-sm">
      ...
      <p className="rounded-2xl border-t bg-black py-4 font-semibold text-neutral-100 dark:bg-background">
        Revealing{" "}
        <span>
