...
export default function NewSecretPage({
  ...
  return (
    <main className="flex w-full flex-col gap-4 rounded-lg">
      ...
      {searchParams.bypass && (
        <div className="mx-4 mb-4 flex items-start gap-2 rounded-lg border border-yellow-500/50 bg-yellow-900/40 p-3 text-xs text-yellow-200/80">
          ...
          <span>
            ...
            only be able to send a secret to{" "}
