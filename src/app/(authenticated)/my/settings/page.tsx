...
export default async function MySettings({
  ...
  return (
    <main className="flex h-full flex-col gap-4 pb-10">
      <header className="sticky inset-0 z-10 flex flex-col bg-background/20 px-4 py-2 backdrop-blur backdrop-filter sm:py-4">
        <h1 className="border-b text-2xl font-bold sm:text-3xl">Settings</h1>
      </header>
